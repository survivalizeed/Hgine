...
#include "../../../Extern/Includes/Bass/bass.h"


#if _WIN32 || _WIN64
#if _WIN64
#pragma comment(lib, "F:\\C++\\Hgine_remake\\Hgine_remake\\Source\\Hgine\\Extern\\x64\\Bass\\bass.lib")  
#else
#pragma comment(lib,"F:\\C++\\Hgine_remake\\Hgine_remake\\Source\\Hgine\\Extern\\x86\\Bass\\bass.lib")  
#endif
#endif

...
#define IS inline static
	...
	struct Storage 
	{
		...
		IS std::vector<ExtendedSprite*> extendedSprites;
	...
	struct Dummy
	{
		...
		IS Square defaultSquare = Square({ 0.f, 0.f }, { 0.f, 0.f }, Color(0, 0, 0), Collider::None, "defaultSquare");
		...
		IS Sprite defaultSprite = Sprite("NONE", Sprite::FileType::Empty, { 0.f, 0.f }, Collider::None, "defaultSprite");
		IS ExtendedSprite defaultExtendedSprite = ExtendedSprite("NONE", Sprite::FileType::Empty, { 0.f,0.f }, Collider::None, "defaultExtendedSprite", Color(0, 0, 0));

...
Make sure you are using C++ 20. For the best results compile it in x64 release, MSVC and -O2 optimization level!  I am trying to re-create some algorithms from the graphics card and thinking about calling it Hgine:)  
...
Please don't wonder if I won't commit weekly. Most of the time Im raising new code to then publish it.

...
#### 15. Go to Hgine -> C++ -> Classes -> LuaScript -> LuaScript.h and change the #pragma comment stuff to the correct path where the lib is located at (it is in the Hgine/Extern folder)
#### 16. Go and copy the x86 bass.dll into your release and debug folder. Go and copy the x64 bass.dll into your x64/release and x64/debug folder. Simply where your exe is located at.
### Done

...
int main() {
	...
	sur::Instancer::Add( new sur::Rectangle({ 200,200 }, { 10,10 }, Color(255, 0, 0), "r", 1),Types::Rectangle);
	sur::Instancer::Add(new sur::Rectangle({ 190,200 }, { 10,10 }, Color(255, 0, 0), "r2", 2),Types::Rectangle);

	for (;;) {
		renderer.ClearScreenBuffer();
		sur::Instancer::Get<sur::Rectangle>(Types::Rectangle, "r")->Bind(true, true);
		sur::Instancer::Get<sur::Rectangle>(Types::Rectangle, "r2")->Bind(true, true);
